...
STATIC_URL = "/static/valuenetwork/"

# Additional locations of static files
STATICFILES_DIRS = [
    os.path.join(PACKAGE_ROOT, "static", "valuenetwork"),
    os.path.join(PACKAGE_ROOT, "static", "bootstrap"),
    os.path.join(PACKAGE_ROOT, "static", "pinax"),
]
